...
export class UsersService {
  ...
  async findAll(): Promise<IUser[]>{
    ...
    if(userData.length == 0 || !userData) throw new NotFoundException('Users data not found');
    return userData;
  }
  ...
  async updateUserById(userId: string, updateStudentDto: CreateUserDto): Promise<IUser>{
